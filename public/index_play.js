...
$(document).ready(function() {
    ...
    function friend_close(){
        if(friend_page==0){
            ...
            setTimeout(()=>{
                ...
                document.getElementById('search_browse').style.display='none'
    ...
    $("#mission_buttom").click(function(){
        ...
        if(mission_page==0) story_back_buttom.style.backgroundImage='url(pic/delete_buttom.png)';
    ...
    $("#story_buttom").click(function(){
        ...
        if(story_page==0) story_back_buttom.style.backgroundImage='url(pic/delete_buttom.png)';
    ...
    $("#story_back_buttom").click(function(){
        if(mission_page!=0){
            if(mission_page==2){
                ...
                document.getElementById('upload_buttom').style.display='inline-block'
                document.getElementById('finish_mission_buttom').style.display='inline-block'
                document.getElementById("mission_buttom").src='pic/mission_buttom.png';
                mission_page=0;
                console.log('mission_page:',mission_page,'mission_select:',mission_select,'story_page:',story_page);
                $("#mission_page2_dot").fadeOut(300)
    ...
    $("#story_anping_buttom").click(function(){
        ...
        document.getElementById("story_confucius_buttom_enter").style.display='none';
        if(story_page==1){
            $('#story_chihkan').fadeOut(500)
            $('#story_confucious').fadeOut(500)
            setTimeout(()=>{
                $('#story_anping').fadeIn(500)
            },500)
        }
        else if(mission_page==1){
            $('#mission_chihkan').fadeOut(500)
            $('#mission_confucious').fadeOut(500)
            setTimeout(()=>{
                $('#mission_anping').fadeIn(500)
            },500)   
        }
        anping=1;
        chihkan=0;
    ...
    $("#story_chihkan_buttom").click(function(){
        ...
        if(story_page==1){
            $('#story_confucious').fadeOut(500)
            $('#story_anping').fadeOut(500)
            setTimeout(()=>{
                $('#story_chihkan').fadeIn(500)
            },500)
        }
        else if(mission_page==1){
            $('#mission_confucious').fadeOut(500)
            $('#mission_anping').fadeOut(500)
            setTimeout(()=>{
                $('#mission_chihkan').fadeIn(500)
            },500)   
        }
        anping=0;
        chihkan=1;
