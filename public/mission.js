...
$("#imgInp1").change(function(){
    readURL1(this);
	take_photo=1;
	console.log('change1 ='+take_photo);
});
//
...
$(document).ready(function() {  
    ...
    $(function(){
        manager.on("swipeleft", function(ev) { 
            if(mission_page==2||mission_page==2.5){
    ...
    $("#detail_info_bottom1").click(function(){
        if(anping_mission[1]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=1) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
            ...
            document.getElementById('mission_page2_intro_picture3').src='pic/anping_picture/anping1_picture4.jpg';
    ...
    $("#detail_info_bottom2").click(function(){
        if(anping_mission[2]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=1) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
            ...
            document.getElementById('mission_page2_intro_picture3').src='pic/anping_picture/anping2_picture4.jpg';
    ...
    $("#detail_info_bottom3").click(function(){
        if(anping_mission[3]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=1) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
            ...
            document.getElementById('mission_page2_intro_picture3').src='pic/anping_picture/anping3_picture4.jpg';
    ...
    $("#detail_info_bottom4").click(function(){
        if(anping_mission[4]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=1) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
            ...
            document.getElementById('mission_page2_intro_picture3').src='pic/anping_picture/anping4_picture4.jpg';
    ...
    $("#detail_info_bottom5").click(function(){
        if(anping_mission[5]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=1) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
            ...
            document.getElementById('mission_page2_intro_picture3').src='pic/anping_picture/anping5_picture4.jpg';
...
//////////////////////
    $("#detail_info_bottom6").click(function(){
        if(chihkan_mission[1]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=2) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom7").click(function(){
        if(chihkan_mission[2]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=2) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom8").click(function(){
        if(chihkan_mission[3]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=2) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom9").click(function(){
        if(chihkan_mission[4]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=2) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom10").click(function(){
        if(chihkan_mission[5]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=2) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom11").click(function(){
        if(confucious_mission[1]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=3) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom12").click(function(){
        if(confucious_mission[2]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=3) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom13").click(function(){
        if(confucious_mission[3]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=3) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom14").click(function(){
        if(confucious_mission[4]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=3) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
    ...
    $("#detail_info_bottom15").click(function(){
        if(confucious_mission[5]>0) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else if(road!=3) $( "#story_background" ).effect( "shake" ,{ distance: 3});
        else{
...
//////////////////////
    ...
    $("#finish_mission_buttom").click(function(){
		...
		var img3 = document.getElementById("blah1")
	...
	count=20000
    if( count/300 < 5){
		$( "#story_background" ).effect( "shake" ,{ distance: 3});
	}
		else{
        mission_page=3;
    ...
    //anping road
        if(mission_select==1){ 
            ...
            $('#mission_page3_title').html(`夕遊出張所`);
...
//////////////
            ...
            document.getElementById("mission_choose_buttom1").src="pic/chihkan/";
            document.getElementById("mission_choose_buttom2").src="pic/chihkan/";
    ...
    //anping road
        if(mission_select==1){
         ...
         //孔廟 road
            ...
            confucious_toggle(mission_select);
            changemysql(mission_select);
        }
        else if(mission_select==12){
        ...
        setTimeout(()=>{
            ...
            $("#mission_choose_buttom1").fadeIn(300)
